...
public class CRUDActivity extends AppCompatActivity implements TaskAdapter.TaskAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> addEmptyTask());
    }
    ...
    private void initDatabase() {
        ...
        tasksRef = database.getReference("iotcontrol/tasks");
    }
    ...
    private void loadData() {
        ...
        tasksRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildChanged(DataSnapshot dataSnapshot, String s) {
                ...
                Log.d("CRUD", String.format("Updating '%s' to '%s'", localItem.getName(), remoteItem.getName()));
    ...
    public void onDoneKeyClick(TaskAdapter adapter, int position) {
        ...
        tasksRef.child(uid).setValue(item).addOnCompleteListener(task -> {
            Toast.makeText(CRUDActivity.this, "Saved: " + item, Toast.LENGTH_SHORT).show();
            addEmptyTask();
        });
    }
