  ...
  */
  ...
  addNotification: function(str){
	cordova.plugins.notification.local.schedule({
		title: 'Padi sudah kering!',
		text: str,
		icon: cordova.file.applicationDirectory + 'www/assets/dryerMedium.png',
        smallIcon: cordova.file.applicationDirectory + 'www/assets/dryerSmall.png',
        sound: cordova.file.applicationDirectory + 'www/assets/ding.mp3',
		color: 'F7CD8D',
		foreground: true
	});
