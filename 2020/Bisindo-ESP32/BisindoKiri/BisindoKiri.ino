...
static const bool pos = false;// false = left, true = right ====================================== Position ======================================
String temp = "0";
int symbolTemp = 0;
/*
  A0 = 36;
  ...
  int ymin = 2048;
*/
static const unsigned int FLEX_PIN1 = 26;
unsigned int flexADC1 = 0;
unsigned int sensorMin1 = 4095; //
unsigned int sensorMax1 = 0; //

static const unsigned int FLEX_PIN2 = 27;
...
static const unsigned int FLEX_PIN4 = 12;
unsigned int flexADC4 = 0;
unsigned int sensorMin4 = 4095;
unsigned int sensorMax4 = 0;

static const unsigned int FLEX_PIN5 = 13;
...
void loop() {//main loop automatically run on esp32 processor core 1
  while (!calibratingFLEX && !calibratingMPU) {
    ...
    if (millis() - timer > 2000) {
      ...
      //printf(" %d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", b1rLower, b2rLower, b3rLower, b4rLower, b5rLower, bprLower, brrLower, byrLower, b1rUpper, b2rUpper, b3rUpper, b4rUpper, b5rUpper, bprUpper, brrUpper, byrUpper, b1lLower, b2lLower, b3lLower, b4lLower, b5lLower, bplLower, brlLower, bylLower, b1lUpper, b2lUpper, b3lUpper, b4lUpper, b5lUpper, bplUpper, brlUpper, bylUpper);
