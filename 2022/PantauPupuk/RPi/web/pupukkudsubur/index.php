...
<html>
	<head>
		<title>Distribusi Pupuk KUD Subur</title>
		<meta charset="UTF-8">
	...
	<body class="w3-light-grey">
      ...
      <div class="w3-bar-block" >
        ...
        <a href="index.php" class="w3-bar-item w3-button w3-padding w3-light-blue"><i class="fa fa-info-circle fa-fw"></i><strong>  Status</strong></a>
        <a href="warehouse.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-info-circle fa-fw"></i>  Gudang</a>
        <a href="history.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>  Riwayat</a>
		  </div>
		</nav>
		...
		<div class="w3-main w3-light-grey" style="margin-left:140px;margin-top:43px;">
		  ...
		  <!-- Feeds panel -->
		  <div class="w3-container" style="margin-left:8px;margin-right:8px;margin-top:auto;">
			<div class="w3-row-padding" style="margin:0 -16px">
				<div id="status" style="margin-top:32px;"></div>
			</div>
		  </div>
		  <hr>
