...
<html>
	...
	<body class="w3-light-grey">
      ...
      <div class="w3-bar-block" >
        ...
        <a href="index.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-info-circle fa-fw"></i><strong>  Kolam A</strong></a>
        <a href="#" class="w3-bar-item w3-button w3-padding w3-grey"><i class="fa fa-info-circle fa-fw"></i><strong>  Kolam B</strong></a>
