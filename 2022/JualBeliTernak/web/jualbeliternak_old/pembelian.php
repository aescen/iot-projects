...
<head>
  ...
  <script>
    const buyItem = JSON.parse(window.sessionStorage.getItem('BUY_ITEM'));
  </script>
...
<body class="w3-light-grey">
          ...
          <div class='w3-cell'>
            <div class="w3-container" style="padding-top:22px">
              <div class='w3-card-4'>
                ...
                <button class="w3-button w3-large w3-block w3-dark-grey">Lanjutkan Pembelian</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <script>
    document.querySelector('#item-img').src = `${buyItem.imgPath}`;
    document.querySelector('#item-id').textContent = `${buyItem.id}`;
    document.querySelector('#item-berat').textContent = `${buyItem.berat}kg`;
    document.querySelector('#item-harga').textContent = `${buyItem.harga}`;
  </script>
</body>
