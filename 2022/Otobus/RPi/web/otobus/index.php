...
<html>
    ...
    <link rel="stylesheet" href="static/styles/organizational_diagram.css">
	...
	<body class="w3-light-grey">
      ...
      <span class="w3-bar-item w3-hide-small w3-hide-medium w3-xlarge"><strong>Otobus</strong></span>
		...
		<!-- Sidebar/menu -->
		<nav class="w3-sidebar w3-card w3-bar-block w3-collapse w3-teal w3-animate-left" style="z-index:3;width:140px;" id="mySidebar">
      ...
      <div class="w3-bar-block" >
        ...
        <div class="w3-cell-row w3-teal">
		  ...
		  <!-- Feeds panel -->
		  <div class="w3-container" style="margin-left:8px;margin-right:8px;margin-top:64px;">
