...
const cordovaApp = {
  ...
  */
  ...
  init: (f7) => {
    ...
    cordovaApp.nativeStorage = NativeStorage;
    // eslint-disable-next-line no-undef
    cordovaApp.notification = cordova.plugins.notification;
    cordovaApp.vibrate = navigator.vibrate;
  ...
  addNotification: (titleStr, textStr) => {
    // eslint-disable-next-line no-undef
    cordova.plugins.notification.local.schedule({
      title: titleStr,
      text: textStr,
      icon: './assets/med.png',
      smallIcon: './assets/low.png',
      sound: './assets/ding.mp3',
      color: '#28b5b5',
      led: { color: '#28b5b5', on: 500, off: 500 },
      foreground: true,
      vibrate: true,
    });
