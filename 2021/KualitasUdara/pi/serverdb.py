            ...
            while network.available():
                try:
                    ...
                    if(header.type == ord('1')):
                        ...
                        # set relay
                        setRelay(pinRelayPurifier, True) if ppm1 > 60 or ppm2 > 60 or ppm3 > 60 else setRelay(pinRelayPurifier, False)
                        setRelay(pinRelayUV, True) if jumlah > 6 else setRelay(pinRelayUV, False)
